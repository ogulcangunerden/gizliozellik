...
const G11 = () => {
  ...
  const items = [
    ...
    "Kadran temasının isteğe bağlı M, M750i veya Alpina olarak değiştirilmesi",
    ...
    "Analog kadran (yarı hayalet) olan araçlarda 750i yazısının aktif edilmesi",
  ...
  return (
    <>
      <Breadcrumb
        pageName="7 Serisi -  G11"
        description="G11 Gizli özellik listesi"
      />
